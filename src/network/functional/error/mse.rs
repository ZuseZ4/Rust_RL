...
impl Error for MeanSquareError {
    ...
    fn loss(&self, output: ArrayD<f32>, target: ArrayD<f32>) -> Array1<f32> {
        ...
        let err = output
            ...
            / n;
        Array1::<f32>::from_elem(1, 0.5 * err)
    }
    ...
    fn loss_from_logits(&self, output: ArrayD<f32>, target: ArrayD<f32>) -> Array1<f32> {
      unimplemented!();
    }
